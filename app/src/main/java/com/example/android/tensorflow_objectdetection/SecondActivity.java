package com.example.android.tensorflow_objectdetection;
...
import com.example.android.tensorflow_objectdetection.classifier.ImageClassifier;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tensor_flow);
